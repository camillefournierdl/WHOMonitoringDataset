...
cache_path <- "cache_geocoded_city_country.csv"
...
write_csv(df_all_geocoded, "datasetWHO-consolidated-geocoded.csv")
...
geo_cache_wave1 <- read_csv("cache_geocoded_city_country.csv", show_col_types = FALSE)

geo_cache_failed_wave1 <- geo_cache_wave1 %>%
  filter(is.na(new_latitude) | is.na(new_longitude))

write_csv(geo_cache_failed_wave1, "geo_cache_failed_wave1.csv")

geo_cache_success_wave1 <- geo_cache_wave1 %>%
  filter(!is.na(new_latitude) & !is.na(new_longitude))

write_csv(geo_cache_success_wave1, "geo_cache_success_wave1.csv")
...
geo_cache_failed_wave1 <- read_csv("geo_cache_failed_wave1.csv", show_col_types = FALSE)
...
second_wave_cache_file <- "cache_geocoded_city_country_secondwave.csv"
...
if (file.exists(second_wave_cache_file)) {
  ...
  geo_cache_success_wave1 <- read_csv("geo_cache_success_wave1.csv", show_col_types = FALSE)
...
geo_cache_wave2 <- read_csv("cache_geocoded_city_country_secondwave.csv", show_col_types = FALSE)
geo_cache_wave2 <- geo_cache_wave2 %>% select(country, city, new_longitude, new_latitude)

geo_cache_failed_wave2 <- geo_cache_wave2 %>%
  filter(is.na(new_latitude) | is.na(new_longitude))

write_csv(geo_cache_failed_wave2, "geo_cache_failed_wave2.csv")

geo_cache_success_wave2 <- geo_cache_wave2 %>%
  filter(!is.na(new_latitude) & !is.na(new_longitude))

write_csv(geo_cache_success_wave2, "geo_cache_success_wave2.csv")

# Save to CSV for manual review
write_csv(geo_cache_failed_wave2, "geo_cache_manual_review.csv")
...
geo_cache_manual_fixed <- read_csv("geo_cache_manual_review_fixed.csv", show_col_types = FALSE)
...
geo_cache_success_wave2 <- read_csv("geo_cache_success_wave2.csv", show_col_types = FALSE)
...
write_csv(geo_cache_final, "cache_geocoded_city_country_final.csv")
