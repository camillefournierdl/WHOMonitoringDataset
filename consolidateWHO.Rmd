...
geo_cache_manual_fixed <- read_csv("geo_cache_manual_review.csv", show_col_types = FALSE)
...
geo_results_wave3 <- geo_results_wave3 %>% select (country, city_fixed = city, latitude = latitude...7, longitude = longitude...8)  
